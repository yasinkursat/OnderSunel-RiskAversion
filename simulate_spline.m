...
%For splines, there may be some instances where the approximation
%generates extreme spreads which distort the spread moments
fprintf('E(R_s)       = %8.4f \n',100*mean(mean(matrix_ra(find(matrix_ra<1)))))
